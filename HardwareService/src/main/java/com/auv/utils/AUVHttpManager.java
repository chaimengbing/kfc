...
public class AUVHttpManager {
    ...
    private AUVHttpManager(Context context) {
...
//        }
    ...
    private static AUVHttpManager instance;// 单例

    public static AUVHttpManager getInstance(Context context) {
        if (instance == null) {
            synchronized (AUVHttpManager.class) {
                if (instance == null) {
                    instance = new AUVHttpManager( context );
                }
            }
        }
        return instance;
            ...
            protected Exception doInBackground(Void... params) {
                ...
                if (set != null) {
                    ...
                    for (Map.Entry<String, Object> entry : set) {
                        sb.append( isFirst ? "?" : "&" );
                        sb.append( Utils.trim( entry.getKey() ) );
                        sb.append( "=" );
                        sb.append( Utils.trim( entry.getValue() ) );
            ...
            protected Exception doInBackground(Void... params) {
                ...
                try {
                    ...
                    if (isJson) {
                        ...
                        if (set != null) {
                            for (Map.Entry<String, Object> entry : set) {
                                builder.add( Utils.trim( entry.getKey() ), Utils.trim( entry.getValue() ) );
                            }
                        }
     ...
     * @param listener
     */
    public void postAuv(final String url, final String request, final int requestCode, final OnHttpResponseListener listener) {
        new AsyncTask<Void, Void, Exception>() {
    ...
    private OkHttpClient getHttpClient(String url) {
        ...
        if (TextUtils.isEmpty( url )) {
            Log.e( TAG, "getHttpClient  Utils.isEmpty(url) >> return null;" );
            return null;
        }
                        ...
                        if (cookies != null) {
                            for (Cookie c : cookies) {
                                if (c != null && c.name() != null && c.value() != null) {
                                    map.put( c.name(), Utils.get( c.value() ) );
                                }
                            }
                        }
...
//        if (url.startsWith( Utils.URL_PREFIXs ) && socketFactory != null) {
